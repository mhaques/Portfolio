...
const ThemeToggleButton = ({ className = '', isDark, onToggle }) => (
  <button type="button" className={className} onClick={onToggle} aria-label="Toggle theme">
    {!isDark ? (
...
export default function Navbar({ isDark, onToggle, onNavClick }) {
